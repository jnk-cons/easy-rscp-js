...
import {MonthlySummaryConverter} from '../../../../src/service/converter/db/monthly-summary-converter';
import {YearlySummaryConverter} from '../../../../src/service/converter/db/yearly-summary-converter';


describe('yearly summary converter tests ', function() {
    it('test conversion', function () {
        const day = new Date(2023, 0, 1, 0, 0,0,0,)

        const _24HoursDuration: Duration = {
            seconds: 24 * 365 * 60 * 60,
            nanos: 0
        }
        ...
        const responseFrame = new FrameBuilder()
            .addData(
                new DataBuilder().tag(DBTag.HISTORY_DATA_YEAR).container(
        ...
        const toTest = new YearlySummaryConverter()
