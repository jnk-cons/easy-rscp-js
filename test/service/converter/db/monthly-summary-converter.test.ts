...
describe('monthly summary converter tests ', function() {
    it('test conversion', function () {
        const day = new Date(2023, 6, 1, 0, 0,0,0,)
        ...
        const responseFrame = new FrameBuilder()
            .addData(
                new DataBuilder().tag(DBTag.HISTORY_DATA_MONTH).container(
        ...
        const toTest = new MonthlySummaryConverter()
